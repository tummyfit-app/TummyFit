...
class TryItAdapter : RecyclerView.Adapter<TryItAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        ListViewHolder(ItemListMealVerticalBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    ...
    inner class ListViewHolder(private val binding: ItemListMealVerticalBinding) :
        ...
        fun bind(item: FoodsItem) {
            binding.apply {
                ...
                buttonMeal.text = String.format(itemView.resources.getString(R.string.kcal_template), item.calories)
